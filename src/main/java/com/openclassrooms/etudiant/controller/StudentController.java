...
public class StudentController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<StudentResponseDTO>> searchStudent(@RequestParam(required=false) String q) {
        return ResponseEntity.ok(studentDtoMapper.toDtoList(studentService.searchStudent(q)));
    }
